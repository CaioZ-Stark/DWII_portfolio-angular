...
if(mb_strlen($mensagem) <= 10) $erros [] = 'Mensagem tem que ser com mais de 10 caracteres.';
...
echo json_encode([
    'sucesso' => true, 'id' => (int) $pdo->lastInsertId(), 'mensagem' => 'Contato recebido com sucesso!'
]);
?>